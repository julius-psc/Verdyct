    ...
    return (
        ...
        >
            ...
            <p className="text-sm text-white/60 line-clamp-3 mb-6 flex-grow font-light leading-relaxed">
                {project.raw_idea || t('card.noDescription')}
            </p>
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between mt-auto">
                <div className="flex items-center gap-4 text-sm text-white/50">
                    <button
                        ...
                        title={hasVoted ? t('card.removeVote') : t('card.upvote')}
                    >
                        <IconFlame
                            size={18}
                ...
                >
                    {t('card.viewReport')} <IconArrowRight size={16} />
                </Link>
            </div>
        </motion.div>
    );
